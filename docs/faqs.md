...
??? danger "`craftoria.net` is BOGUS"
    That site is **not** owned or run by us and we do not affiliate with it. It was created by an unknown entity without permission and contains a *lot* of false information about [***Craftoria***](../modpacks/Craftoria).
